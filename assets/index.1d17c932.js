var I=Object.defineProperty,P=Object.defineProperties;var _=Object.getOwnPropertyDescriptors;var A=Object.getOwnPropertySymbols;var z=Object.prototype.hasOwnProperty,T=Object.prototype.propertyIsEnumerable;var x=(a,s,n)=>s in a?I(a,s,{enumerable:!0,configurable:!0,writable:!0,value:n}):a[s]=n,k=(a,s)=>{for(var n in s||(s={}))z.call(s,n)&&x(a,n,s[n]);if(A)for(var n of A(s))T.call(s,n)&&x(a,n,s[n]);return a},b=(a,s)=>P(a,_(s));var v=(a,s)=>{var n={};for(var t in a)z.call(a,t)&&s.indexOf(t)<0&&(n[t]=a[t]);if(a!=null&&A)for(var t of A(a))s.indexOf(t)<0&&T.call(a,t)&&(n[t]=a[t]);return n};import{R as p,a as $,b as M}from"./vendor.cb2082f2.js";const O=function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function n(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerpolicy&&(o.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?o.credentials="include":e.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(e){if(e.ep)return;e.ep=!0;const o=n(e);fetch(e.href,o)}};O();const N=`<h1>A demo of <code>panel-manager</code></h1>
...
<li>Built-in panel size cache</li>
</ul>
<h2>Install</h2>
